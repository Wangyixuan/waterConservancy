...
#import "WLUploadDetailInfoView.h"
...
@interface WLUploadDetailInfoView()<UITextFieldDelegate,YYTextViewDelegate>
...
@implementation WLUploadDetailInfoView
...
-(void)initUI{
    ...
    [self.topBgImageView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.left.mas_equalTo(weak_self).offset(5);
        make.right.mas_equalTo(weak_self).offset(-5);
        make.height.mas_equalTo(15);
    }];
    [self.bottomBgImageView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(weak_self).offset(5);
        make.right.bottom.mas_equalTo(weak_self).offset(-5);
        make.height.mas_equalTo(15);
    }];
    ...
    [self.lineView1 mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(weak_self).offset(75);
...
-(UITextField*)placeHoldLab{
    if (!_placeHoldLab) {
        ...
        [self addSubview:field];
        [self insertSubview:field belowSubview:self.descText];
        field.userInteractionEnabled = NO;
        _placeHoldLab = field;
    }
...
-(UIButton*)chooseGradBtn{
    if (!_chooseGradBtn) {
        ...
        [self addSubview:btn];
        [self insertSubview:btn aboveSubview:self.gradText];
        _chooseGradBtn = btn;
    }
