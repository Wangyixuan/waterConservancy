...
//    self.activity.userInteractionEnabled = NO;
    ...
    [self.faildView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(weak_self.view.mas_left).offset(SCALE_W(100));
        make.top.mas_equalTo(weak_self.view.mas_top).offset(SCALE_W(100));
        make.right.mas_equalTo(weak_self.view.mas_right).offset(SCALE_W(-100));
        make.bottom.mas_equalTo(weak_self.view.mas_bottom).offset(SCALE_W(-100));
    }];
